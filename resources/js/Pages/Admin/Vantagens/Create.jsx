...
import { Plus, Save, RefreshCw, ArrowLeft } from "lucide-react";
                ...
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    <Card className="bg-white/80 backdrop-blur-sm border-2">
                        <CardHeader>
                            ...
                            <CardDescription>
                                Preencha os dados da nova vantagem do consórcio
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500 mt-1">
                                            Deixe em branco para usar a próxima
                                            ordem disponível
                                        </p>
